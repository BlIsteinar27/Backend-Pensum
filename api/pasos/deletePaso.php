...
if ($id > 0) {
    ...
    if ($stmt->execute()) {
        echo json_encode(["success" => true, "message" => "Paso eliminado exitosamente."]);
    } else {
        echo json_encode(["success" => false, "message" => "Ocurrió un error al eliminar el paso seleccionado: " . $stmt->error]);
    }
